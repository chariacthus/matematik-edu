...
export function buildSystemPrompt(opts: {
  ...
  return [
    ...
    '   hele løsningen, for da hjælper det ikke længere at holde eleven hen.',
    ...
    '7. Skriv som en lærer taler: korte, almindelige sætninger. Ingen tankestreger (—), ingen',
    '   "Lad os …" i hver besked, ingen floskler som "Godt spørgsmål!" og ingen emojis.',
    '',
